...
-- Websocket stream, just for example
...
-- Create a biew which compute the 5 biggest btc volume
...
-- Stream websocket with 5 biggest btc volume (at start, no refresh yet)
